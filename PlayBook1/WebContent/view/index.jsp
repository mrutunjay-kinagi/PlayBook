...
<div class="container">
		...
		<p>
			<div class="recent">
				<button class="btn-primarys"><h3>Choose your desired scope..</h3></button>
				<hr>
			</div>
		</div>
	</div>
				...
				<div class="col-md-4">
					<div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
						<div class="align-center">
							...
							<div class="ficon">
								<a href="CRM.obj" >Explore</a> <i class="fa fa-long-arrow-right"></i>
							</div>
						</div>
					</div>
				</div>
									...
									<div class="slides" data-group="slides">
										<ul> 	    		
											<div class="slide-bodys" data-group="slide">
												<li><img alt="" class="img-responsive" src="<c:url value="/view/img/3.jpg"/>" width="100%" height="450"/></li>
												<li><img alt="" class="img-responsive" src="<c:url value="/view/img/4.jpg"/>" width="100%" height="450"/></li>
												<li><img alt="" class="img-responsive" src="<c:url value="/view/img/5.jpg"/>" width="100%" height="450"/></li>
											</div>
										</ul>
									</div>
								</div>
